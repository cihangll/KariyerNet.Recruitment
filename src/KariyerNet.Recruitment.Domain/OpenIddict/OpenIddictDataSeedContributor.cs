...
namespace KariyerNet.Recruitment.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
	...
	{
		if (await _openIddictScopeRepository.FindByNameAsync("Recruitment") == null)
		{
	...
	private async Task CreateApplicationsAsync()
	{
		...
		// Blazor Client
		var blazorClientId = configurationSection["Recruitment_Blazor:ClientId"];
		if (!blazorClientId.IsNullOrWhiteSpace())
		{
			var blazorRootUrl = configurationSection["Recruitment_Blazor:RootUrl"]?.TrimEnd('/');
		...
		// Swagger Client
		var swaggerClientId = configurationSection["Recruitment_Swagger:ClientId"];
		if (!swaggerClientId.IsNullOrWhiteSpace())
		{
			var swaggerRootUrl = configurationSection["Recruitment_Swagger:RootUrl"]?.TrimEnd('/');
		...
		var postmanClientId = configurationSection["Recruitment_Postman:ClientId"];
